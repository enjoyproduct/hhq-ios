...
class API: NSObject {
    ...
    static let DOWNLOAD_OFFICIAL_RECEIPT = BASE_API_URL + "files/officialreceipt/%d/download"
    static let DOWNLOAD_TICKET_FILE = BASE_API_URL + "tickets/download?path=%@&name=%@"
